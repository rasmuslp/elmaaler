...
def solve( instance, count ):
    ...
    print "* Found value of %d when looking for %d in instance %d using %d iterations " % ( best_state.consumes, instance.measured_consumption, instance.number, iterations )
    print "** %d best states " % count
    pp.pprint( best_states.str_nsmallest(count) )
